...
public class Picture {
	...
	static private String getSYGCode(String abbreviation){
		String code="";
		try{
			BufferedReader br = new BufferedReader(new FileReader("./nba/teams/"+abbreviation+".svg")); 
			String line="";
	...
	static private void convertToPng(String svgCode, OutputStream outputStream) throws Exception{
	...
	public JSVGCanvas getSwing(String abbreviation){
		...
		s.loadSVGDocument("file:/" + path + "/nba/teams/"+abbreviation+".svg");
		return s;
	}
}
