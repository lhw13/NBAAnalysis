...
public class MainFrame {
	...
	private void initialize() {
		...
		lblNewLabel_6.setIcon(new ImageIcon("pictures\\lakers.jpg"));
		...
		lblNewLabel.setIcon(new ImageIcon("pictures\\middle.jpg"));
	...
	private class ScheduleTask extends TimerTask {
        public void run() {
        	...
        	lblNewLabel_6.setIcon(new ImageIcon("pictures\\ROYALTY.jpg"));
        	try {
        		Thread.sleep(3000);
        		} 
        	catch (InterruptedException e) {
        	...
        	lblNewLabel_6.setIcon(new ImageIcon("pictures\\WADE2.jpg"));
        	try {
        		Thread.sleep(3000);
        		} 
        	catch (InterruptedException e) {
