...
public class MatchesDataAnalyse {
 ...
 private static PlayerInMatchesPO stringToPlayerInMatchesPO(String playerInMatches){
	 String[] player=playerInMatches.split(";");
		...
		if(playTime.split(":").length==2){
		 playTimeBySeconds=stringToInt(playTime.split(":")[0])*60+stringToInt(playTime.split(":")[1]);
		}
